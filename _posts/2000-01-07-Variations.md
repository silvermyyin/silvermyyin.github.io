...
The Kriple model of this typical variation is shown in Fig. 12-15 from before the announcement to Day 2. We use Mesa to illustrate the variation of number of states in Kripke model (Fig. 16) and number of alive islanders day by day (Fig.17).
